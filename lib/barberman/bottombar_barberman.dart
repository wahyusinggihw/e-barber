...
class BottomBarBarberman extends StatefulWidget {
  // const BottomBarBarberman({Key? key}) : super(key: key);
  @override
  _BottomBarBarbermanState createState() => _BottomBarBarbermanState();
}

class _BottomBarBarbermanState extends State<BottomBarBarberman> {
  int _currentIndex = 0;
